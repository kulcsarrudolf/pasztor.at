...
![An illustration of the pop-up window IntelliJ shows to warn the user that the Maven configuration needs to be imported.](posts/intellij-auto-import-maven.png)
...
![Illustration of creating a new Java class in IntelliJ](posts/intellij-new-java-file.png)
...
![An illustration of how to run an application in IntelliJ by clicking on the little green arrow.](posts/intellij-run.png)
...
![An illustration of the IntelliJ console showing the application running.](posts/intellij-restart.png)
