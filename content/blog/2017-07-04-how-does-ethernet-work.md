...
- [Wikipedia article on Ethertype](https://en.wikipedia.org/wiki/EtherType)
- [List of IEEE 802.1 standards](https://en.wikipedia.org/wiki/IEEE_802.1)
- [Unicast flood](https://en.wikipedia.org/wiki/Unicast_flood)
